...
[🤗 Weights & model card on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-infused-phi3-mini-4k-gguf) · [abteex.com](https://abteex.com) · [lumynax.com](https://lumynax.com) · [Monorepo](https://github.com/Aimaghsoodi/lumynax-release)

---

This GitHub repo mirrors the **runtime scaffolding** (quickstart, requirements, Modelfile, Space, docs). The model **weights** are published on Hugging Face at `AbteeXAILab/lumynax-infused-phi3-mini-4k-gguf` — they exceed GitHub's per-file limit.

```bash
hf download AbteeXAILab/lumynax-infused-phi3-mini-4k-gguf --local-dir lumynax-infused-phi3-mini-4k-gguf
cd lumynax-infused-phi3-mini-4k-gguf && pip install -r requirements.txt && python quickstart.py --interactive
# Or:  pip install lumynax && lumynax run lumynax-infused-phi3-mini-4k-gguf -i
```
